 ...
 * @author Mark
 */
@WebServlet(name = "initializeHomepage", urlPatterns = {"/initializeHomepage"})
public class initializeHomepage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            SimpleDateFormat sdfMonth = new SimpleDateFormat("MMMM");//dd/MM/yyyy
            Date now = new Date();
            String strDate = sdfDate.format(now);
            String strMonth = sdfMonth.format(now);
            session.setAttribute("CurrentMonth", strMonth);
