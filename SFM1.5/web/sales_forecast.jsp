<%-- 
    Document   : sales_forecast
    Created on : 11 10, 14, 4:07:04 AM
    Author     : Mark
--%>
...
<html>
    <head>
        ...
        <title>Sales Forecast | Sales Force Management</title>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="inner_wrapper">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="sales_trendingstats.jsp">Trending Statistics</a></li>
