...
P.prototype={
    ...
    colorGradient:function(a,b,c){
        ...
        if(f){
            ...
            for(n in g)n!=="id"&&s.push(n,g[n]);for(n in j)s.push(j[n]);s=s.join(",");
...
label:function(a,b,c,d,e,f,g,h,i){
    ...
    zIndex:1
}),m,J,L=0,x=3,v=0,Va,wb,xb,yb,y=0,B={},na,
z;
n.onAdd=function(){
    s.add(n);
    n.attr({
...
if(!aa&&!fa){
    R.VMLElement=X={
        ...
        pathToVML:function(a){
            for(var b=a.length,c=[];b--;)if(ha(a[b]))c[b]=u(a[b]*10)-5;
                else if(a[b]==="Z")c[b]="x";
                else if(c[b]=a[b],a.isArc&&(a[b]==="wa"||a[b]==="at"))c[b+5]===c[b+7]&&(c[b+7]+=a[b+7]>a[b+5]?1:-1),c[b+6]===c[b+8]&&(c[b+8]+=a[b+8]>a[b+6]?1:-1);return c.join(" ")||"x"
            },
        clip:function(a){
            var b=this,c;
...
color:function(a,b,c,d){
    ...
    if(i){
        ...
        if(c==="fill")if(i==="gradient")c=o.x1||o[0]||0,a=o.y1||o[1]||0,n=o.x2||o[2]||0,o=o.y2||o[3]||0,x='angle="'+(90-U.atan((o-a)/(n-c))*180/ma)+'"',q();
            else{
...
R.PlotLineOrBand.prototype={
    render:function(){
        ...
        if(n)if(s)n.animate({
            ...
            },x)d(p);if(f&&r(f.text)&&s&&s.length&&b.width>0&&b.height>0){
            f=w({
                align:c&&k&&"center",
                x:c?!k&&4:10,
...
init:function(a,b){
    ...
    for(f in d)K(this,f,d[f]);if(this.isLog)this.val2lin=za,this.lin2val=ia
        },
...
defaultLabelFormatter:function(){
    ...
    else if(f&&a>=1E3)for(;f--&&g===t;)c=Math.pow(1E3,f+1),a>=c&&e[f]!==null&&(g=Ga(b/c,-1)+e[f]);
...
setScale:function(){
    ...
    if(e||d||this.isLinked||this.forceRedraw||this.userMin!==this.oldUserMin||this.userMax!==this.oldUserMax){
        if(!this.isXAxis)for(b in a)for(c in a[b])a[b][c].total=null,a[b][c].cum=0;this.forceRedraw=!1;
...
destroy:function(a){
    ...
    a||W(b);
    for(d in c)Oa(c[d]),c[d]=null;p([b.ticks,b.minorTicks,b.alternateBands],function(a){
        Oa(a)
        });
    ...
    runPointActions:function(a){
        ...
        if(d&&this.options.tooltip.shared&&(!h||!h.noSharedTooltip)){
            ...
            for(j=0;j<i;j++)if(c[j].visible&&c[j].options.enableMouseTracking!==!1&&!c[j].noSharedTooltip&&
                c[j].singularTooltips!==!0&&c[j].tooltipPoints.length&&(e=c[j].tooltipPoints[l])&&e.series)e._dist=M(l-e.clientX),k=C(k,e._dist),f.push(e);for(i=f.length;i--;)f[i]._dist>k&&f.splice(i,1);
...
Ya.prototype={
    ...
    if(e)for(g in e)K(f,g,e[g]);f.xAxis=[];
    f.yAxis=[];
...
redraw:function(a){
    ...
    if(h)for(k=j;k--;)if(a=c[k],a.options.stacking)a.isDirty=!0;p(c,function(a){
...
O.prototype={
    ...
    init:function(a,b){
        ...
        if(fa)b.animation=!1;
        e=b.events;
        for(d in e)K(c,d,e[d]);if(e&&e.click||b.point&&b.point.events&&b.point.events.click||b.allowPointSelect)a.runTrackerClick=!0;
        c.getColor();
        c.getSymbol();
    ...
    setData:function(a,b,c,d){
        ...
        if(d!==!1&&h&&g===h&&!e.cropped&&!e.hasGroupedData)p(a,function(a,b){
            ...
            if(s&&h>s){
                ...
                series:e
            },e.pointClass.prototype.applyOptions.apply(i,[a[c]]),e.updateParallelArrays(i,c),o&&i.name))l.names[i.x]=i.name;Fa(r[0])&&ra(14,!0);
            e.data=[];
            e.options.data=a;
    ...
    processData:function(a){
        ...
        if(l&&this.sorted&&(!j||d>j||this.forceCrop))if(o=h.min,n=h.max,b[d-1]<o||b[0]>n)b=[],c=[];
...
getExtremes:function(a){
    ...
    d=a.length;
    for(l=0;l<d;l++)if(j=c[l],k=a[l],i=k!==null&&k!==t&&(!b.isLog||k.length||k>0),j=this.getExtremesFromAll||this.cropped||(c[l+1]||j)>=g&&(c[l-1]||j)<=h,i&&j)if(i=k.length)for(;i--;)k[i]!==null&&(e[f++]=k[i]);else e[f++]=k;this.dataMin=m(void 0,Na(e));
...
convertAttribs:function(a,
    ...
    for(f in e)g=e[f],h[f]=m(a[g],b[f],c[f],d[f]);return h
    },
getAttribs:function(){
    ...
    if(!i||g<i||k)for(;g--;){
        ...
        if(i.options)for(m in l)r(c[l[m]])&&(k=!0);if(k){
            c=c||{};
...
q(O.prototype,{
    ...
    update:function(a,b){
        ...
        this.remove(!1);
        for(f in e)e.hasOwnProperty(f)&&(this[f]=t);q(this,F[a.type||d].prototype);
        this.init(c,a);
        m(b,!0)&&c.redraw(!1)
        }
    });
...
var pa=ka(O,{
    ...
    getSegments:function(){
        ...
        if(this.options.stacking&&!this.cropped){
            ...
            for(n in f)f[n].total!==null&&c.push(+n);c.sort(function(a,b){
                return a-b
                });
            p(c,function(a){
    ...
    if(d.enabled||a._hasPointLabels)a.dlProcessOptions&&a.dlProcessOptions(d),i=a.plotGroup("dataLabelsGroup",
        ...
        if(l&&!e)b.dataLabel=l.destroy();
            ...
            if(l)if(r(h))l.attr({
                ...
                for(n in l)l[n]===t&&delete l[n];l=b.dataLabel=a.chart.renderer[e?"text":"label"](h,0,-999,null,null,null,d.useHTML).attr(l).css(q(d.style,c&&{
                    cursor:c
...
S=R.TrackerMixin={
    ...
    drawTrackerGraph:function(){
        var a=this,b=a.options,c=b.trackByArea,d=[].concat(c?a.areaPath:
            a.graphPath),e=d.length,f=a.chart,g=f.pointer,h=f.renderer,i=f.options.tooltip.snap,j=a.tracker,k=b.cursor,l=k&&{
            cursor:k
...
q(Ea.prototype,{
    ...
    importEvents:function(){
        if(!this.hasImportedEvents){
            ...
            this.events=a;
            for(b in a)K(this,b,a[b]);this.hasImportedEvents=!0
            }
        },
setState:function(a,
    b){
